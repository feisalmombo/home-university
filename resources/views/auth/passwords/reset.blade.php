...
<html lang="en">
  <head>
    ...
    <title>Home University | Reset Password</title>
    <!-- web fonts -->
      ...
      <div class="login-form py-5 px-4 mx-auto">
        ...
        <form action="#" method="GET">
          <div class="form-group">
            <label class="field-info" for="inputEmail">Active Email</label>
            <input type="email" class="form-control" name="Email" id="inputEmail" required="">
          </div>
          <div class="form-group">
            <label class="field-info" for="inputNewPassword">New Password</label>
            <input type="password" class="form-control" id="inputNewPassword" required="">
          </div>

          <div class="form-group">
            <label class="field-info" for="inputConfirmNewPassword">Confirm New Password</label>
